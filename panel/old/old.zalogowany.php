...
<html lang="pl-PL">
	...
	<body>
		...
		<div id="panel5">
			Menu 
			<hr>
			<a href="zalogowany.php"><font color="green">Strona Główna</font></a>
			<br>
		...
		<div id="panel">
			...
			<br>
			<?php
				echo "<font color=\"green\">Numer konta </font><font color\"#262626\">".$_SESSION['numer_konta']."</font><br>";
				echo "<font color=\"green\">Adres zamieszkania </font><font color\"#262626\">".$_SESSION['adres']."</font><br>";
				echo "<font color=\"green\">Numer Telefonu </font><font color\"#262626\">".$_SESSION['nr_telefonu']."</font><br>";
			?>
			&emsp;
		</div>
		<br>
