...
<html lang="pl-PL">
	...
	<body>
		...
		<div id="panel5">
			...
			<br>
			<a href="sprawdz_klienta.php"><font color="green">Sprawdź Klienta</font></a>
			<br>
		...
		<div id="panel423">
			<br>
				<?php 
					...
					echo "<td><font color=\"#005ce6\">numer_rezerwacji</td>";
					echo "<td><font color=\"#005ce6\">Imie</td>";
					echo "<td><font color=\"#005ce6\">Nazwisko</td>";
					echo "<td><font color=\"#005ce6\">Pesel</td>";
					echo "<td><font color=\"#005ce6\">Data Urodzenia</td>";
					echo "<td><font color=\"#005ce6\">Adres Zamieszkania</td>";
					echo "<td><font color=\"#005ce6\">Data Meldunku</td>";
					echo "<td><font color=\"#005ce6\">Data wymeldunku</td>";
					echo "<td><font color=\"#005ce6\">Wyzywienie</td>";
					echo "<td><font color=\"#005ce6\">Platnosc</td>";
		...
		<br>
			<?php
				$conn = new mysqli('localhost','root','rambov1337');
				// Check connection
				if ($conn->connect_error) {
					die("<font color=\"red\">Blad MYSQL!</font>");
				}
				   	echo"
						<div id=\"down\">
							<p align=\"right\">
