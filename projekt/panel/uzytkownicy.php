...
<html lang="pl-PL">
	...
	<body oncontextmenu="return false;">
		...
		<?php
			include "include/uzytkownicy_edit_del.php";
		?>
		<?php
			...
			<div class="row content">
				...
				<div class="col-sm-8 text-left"> 
					...
					<table class="table table-bordered">
						...
						<tbody id="Lista">
						<?php
							include "include/uzytkownicy_lista.php";
						?>
						</tbody>
					</table>
					<a href="uzytkownicy.php?a=add" class="btn btn-success" role="button">Dodaj użytkownika</a>
					<script>
